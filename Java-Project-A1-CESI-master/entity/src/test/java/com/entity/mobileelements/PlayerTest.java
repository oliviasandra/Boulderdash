...
public class PlayerTest extends EntityTest {
    ...
    private static final Sprite spriteDown = new Sprite('y', "rockforddown.gif");
    /** The left sprite of the player */
    private static final Sprite spriteTurnLeft = new Sprite('y', "rockfordleft.gif");
    /** The right sprite of the player */
    private static final Sprite spriteTurnRight = new Sprite('y', "rockfordright.gif");
    /** The up sprite of the player */
    private static final Sprite spriteUp = new Sprite('y', "rockfordup.gif");
